# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 10:07:57 2020
...
f_out1=file("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/Y_sampling_DPP_gamma="+str(gamma)+"_1800points_1.txt","w")
f_out2=file("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/Y_independent_1800points_1.txt","w")
f_out3=file("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/Y_sampling_DPP_gamma="+str(gamma)+"_1800points_2.txt","w")
f_out4=file("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/Y_independent_1800points_2.txt","w")
...
#            u[i,j] = -math.log(abs(x[i]-x[j]))-gamma*math.log(abs(math.exp(x[i])-math.exp(x[j])))
            u[i/10,j/10] = -math.log(abs(x[i]-x[j]))-gamma*math.log(abs(math.exp(x[i])-math.exp(x[j])))
